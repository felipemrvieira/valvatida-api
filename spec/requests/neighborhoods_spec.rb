...
RSpec.describe "/neighborhoods", type: :request do
  ...
  # NeighborhoodsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get neighborhoods_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
      ...
      it "creates a new Neighborhood" do
        expect {
          post neighborhoods_url,
               params: { neighborhood: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Neighborhood" do
        expect {
          post neighborhoods_url,
               params: { neighborhood: invalid_attributes }, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested neighborhood" do
      neighborhood = Neighborhood.create! valid_attributes
      expect {
        delete neighborhood_url(neighborhood), headers: valid_headers, as: :json
      }.to change(Neighborhood, :count).by(-1)
    end
  end
end
